          ...
          <div className="contact-form-card">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-[0_2px_24px_rgba(1,186,240,0.08),0_1px_4px_rgba(10,22,40,0.05)] border border-[#dde8f0]">
              ...
              <div
                ...
                className="mb-6 flex items-center justify-between gap-4 px-5 py-4 rounded-xl border border-[#01baf0]/30 bg-[#f0fbff] hover:bg-[#e0f6fd] hover:border-[#01baf0]/60 cursor-pointer transition-all duration-200 group"
              >
                <div>
                  <p className="text-[13px] font-semibold text-[#0a1628]">
                    Ready to commit?
                  </p>
                  <p className="text-[12px] text-[#7a90a8] mt-0.5">
                    Skip the message — fill our full booking form directly.
                  </p>
                </div>
                <div className="shrink-0 flex items-center gap-1.5 text-[#01baf0] text-[13px] font-semibold group-hover:gap-2.5 transition-all duration-200">
                  Book Now
