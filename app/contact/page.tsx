...
export default function Contact() {
  ...
  return (
    <div
      ...
      style={{ height: "100dvh" }}
    >
      {/* Background — fixed so keyboard open never shifts it */}
      ...
      >
        {/* Page content */}
        <div className="flex items-start justify-center px-4 pb-20 pt-8 min-h-full">
          <div className="w-full max-w-[560px]">
            ...
            <div className="text-center m-10">
              ...
              <p className="text-sm text-white/40">
                Tell us about your dream trek and we'll craft the perfect plan
                for you.
              </p>
            </div>
