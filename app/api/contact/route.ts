                    ...
                    <tr>
                      <td style="background:#ffffff;padding:36px 40px;">
                        ...
                        <p style="margin:0 0 24px;font-size:15px;color:#374151;">
                          Hi team, you have a new inquiry from <strong>${firstName} ${lastName}</strong>. Here are the details:
                        </p>
                          ...
                          <tr>
                            <td style="padding:0 0 12px;">
                              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:10px;border:1px solid #e5e7eb;">
                                <tr>
                                  <td style="padding:14px 18px;">
                                    <p style="margin:0 0 2px;font-size:10px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#9ca3af;">Interest</p>
                                    <p style="margin:0;font-size:15px;font-weight:600;color:#111827;">${interest}</p>
                                  </td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr>
                            <td style="padding:0 0 0;">
                              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:10px;border:1px solid #e5e7eb;">
                                <tr>
                                  <td style="padding:14px 18px;">
                                    <p style="margin:0 0 8px;font-size:10px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#9ca3af;">Message</p>
